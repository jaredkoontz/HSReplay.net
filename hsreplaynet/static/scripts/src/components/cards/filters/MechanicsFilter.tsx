	...
	public render(): React.ReactNode {
		...
		return (
			...
			>
				...
				<CardFilterItem value={"CHARGE"}>
					{t("GLOBAL_KEYWORD_CHARGE")}
				</CardFilterItem>
				...
				<CardFilterItem value={"RITUAL"}>{t("C'Thun")}</CardFilterItem>
				...
				<CardFilterItem value={"TWINSPELL"}>
					{t("GLOBAL_KEYWORD_TWINSPELL")}
				</CardFilterItem>
				<CardFilterItem value={"REBORN"}>
					{t("GLOBAL_KEYWORD_REBORN")}
				</CardFilterItem>
			</CardFilterItemGroup>
		);
	}
...
export default withTranslation()(MechanicsFilter);
